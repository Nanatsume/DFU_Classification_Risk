"""Threshold Optimisation: Youden's Index on the best backbone from RQ1.
...
Saves results to results/threshold_results.json.
...
def main():
    ...
    out = os.path.join(CONFIG['results_dir'], 'threshold_results.json')
